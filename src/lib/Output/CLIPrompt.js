...
export default class CLIPrompt {
	...
	getPrompts() {
		this.#summary ? this.removePrompt('summary') : null
		this.#description ? this.removePrompt('description') : null
		this.#type ? this.removePrompt('type') : null
		this.#scope ? this.removePrompt('scope') : null
